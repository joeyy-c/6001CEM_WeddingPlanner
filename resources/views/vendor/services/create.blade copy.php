...
<body>
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="../../index.html"><img src="{{ asset('images/administrator/logo.svg') }}" class="mr-2" alt="logo"/></a>
        <a class="navbar-brand brand-logo-mini" href="../../index.html"><img src="{{ asset('images/administrator/logo-mini.svg') }}" alt="logo"/></a>
      </div>
        ...
        <ul class="navbar-nav navbar-nav-right">
          ...
          <li class="nav-item nav-profile dropdown">
            <a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown" id="profileDropdown">
              <img src="{{ asset('images/administrator/faces/face28.jpg') }}" alt="profile"/>
            </a>
          ...
          <div class="tab-pane fade" id="chats-section" role="tabpanel" aria-labelledby="chats-section">
            ...
            <ul class="chat-list">
              <li class="list active">
                <div class="profile"><img src="{{ asset('images/administrator/faces/face1.jpg') }}" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Thomas Douglas</p>
                  <p>Available</p>
                </div>
              ...
              <li class="list">
                <div class="profile"><img src="{{ asset('images/administrator/faces/face2.jpg') }}" alt="image"><span class="offline"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="{{ asset('images/administrator/faces/face3.jpg') }}" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Daniel Russell</p>
                  <p>Available</p>
                </div>
              ...
              <li class="list">
                <div class="profile"><img src="{{ asset('images/administrator/faces/face4.jpg') }}" alt="image"><span class="offline"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="{{ asset('images/administrator/faces/face5.jpg') }}" alt="image"><span class="online"></span></div>
                <div class="info">
              ...
              <li class="list">
                <div class="profile"><img src="{{ asset('images/administrator/faces/face6.jpg') }}" alt="image"><span class="online"></span></div>
                <div class="info">
                  <p>Sarah Graves</p>
                  <p>Available</p>
                </div>
          ...
          <div class="col-12 grid-margin">
            <div class="card">
              <div class="card-body">
                ...
                <form class="form-style-2" action="{{ route('services.store') }}" method="post">
                  @csrf
                  @method('post')
                      ...
                      @case('venue')
                          <div id="venue_field">
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group row">
                                  <label class="col-sm-3 col-form-label">Max guest capacity</label>
                                  <div class="col-sm-9">
                                    <input class="form-control" type="number" id="max_guest_capacity" name="max_guest_capacity" min="1" step="1" placeholder="Eg. 200, 400, 600, ..." required />
                                  </div>
                                </div>
                              </div>
                            </div>
                            ...
                            <div class="row">
                              <div class="col-md-6">
                                <div class="form-group row">
                                  ...
                                  <div class="col-sm-9">
                                    <input class="form-control" type="number" id="count_of_guest" name="count_of_guest" min="1" step="1" placeholder="Eg. 200, 400, 600, ..." required />
                                  </div>
                                </div>
                              </div>
                            </div>
  ...
  <script src="{{ asset('js/administrator/file-upload.js') }}"></script>
  <script src="{{ asset('js/administrator/typeahead.js') }}"></script>
  <script src="{{ asset('js/administrator/select2.js') }}"></script>
